...
public class type18{
    public class skill322 : monoskill{
        ...
        public override IEnumerator skill_effect(y_color attacker, y_color defender){
            ...
            GameObject prefab = Resources.Load<GameObject>("Prefab/MagmaOath");
    ...
    {
        public skill331() : base(331, "쾌청", 0, 100, 18, 3, false, 100, "날씨를 쾌청 상태로 만든다")
        {
        }
    ...
    public class skill422 : monoskill
    {
        ...
        public override IEnumerator skill_effect(y_color attacker, y_color defender)
        {
            ...
            GameObject prefab = Resources.Load<GameObject>("Prefab/MagmaBall");
            GameObject go = UnityEngine.Object.Instantiate(
                prefab,
                attacker.transform.position,
                prefab.transform.rotation
